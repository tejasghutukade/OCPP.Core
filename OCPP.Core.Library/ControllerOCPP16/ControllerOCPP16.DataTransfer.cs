    ...
    public partial class ControllerOcpp16
    {
        public string HandleDataTransfer(OcppMessage msgIn, OcppMessage msgOut)
        {
            ...
            try
            {
                ...
                Logger.Verbose("DataTransfer => Response serialized");
            }
            catch (Exception exp)
            {
                Logger.Error(exp, "DataTransfer => Exception: {0}", exp.Message);
