...
namespace OCPP.Core.DatabaseOld
{
    public partial class OCPPCoreContext : DbContext
    {
        ...
        public OCPPCoreContext(DbContextOptions<OCPPCoreContext> options , ILogger logger)
            : base(options)
        {
            _logger = logger;
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                // string mySqlConnString = _configuration.GetConnectionString("MySqlServer");
                ...
                // }
                // else if (!string.IsNullOrWhiteSpace(mySqlConnString))
                // {
                //     ServerVersion serverVersion = new MariaDbServerVersion(new Version(10,4,12));
                //     optionsBuilder.UseMySql(mySqlConnString,serverVersion);
                // }
            }
        }
